...
private:
	...
	std::unique_ptr<BasicOutputHandler> outputHandler[NUMBER_OF_STREAM_SERVERS];
	...
	obs_hotkey_pair_id streamingHotkeys[NUMBER_OF_STREAM_SERVERS], recordingHotkeys,
	                   replayBufHotkeys;
...
public slots:
	...
	void StopStreaming(int id);
	void ForceStopStreaming(int id);
...
#pragma endregion
	...
	void StartReplayBuffer(int id);
	void StopReplayBuffer(int id);
